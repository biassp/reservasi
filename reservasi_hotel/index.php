...
<head>
    <meta charset="UTF-8">
    <title>Aplikasi Meeting Room Booking</title>
    <!-- demo stylesheet -->
...
<body>
    <div id="header">
        <div class="bg-help">
            <div class="inBox">
                <h1 id="logo"><a href="https://biassp.github.io/"> (Nama Perusahaan) </a></h1>
                <p id="claim"><a href="https://biassp.github.io/">BiasDev</a> - Motto Perusahaan</p>
                <hr class="hidden" />
            </div>
        </div>
    </div>
